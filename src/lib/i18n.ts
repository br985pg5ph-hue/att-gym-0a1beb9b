...
export const dict: Record<Lang, Dict> = {
  en: {
    ...
    home: "Home", book: "Book", coaches: "Coaches", news: "News", profile: "Profile", admin: "Admin",
  ...
  ar: {
    ...
    home: "الرئيسية", book: "احجز", coaches: "المدربون", news: "الأخبار", profile: "الملف", admin: "الإدارة",
