...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Antaki Top Team — Muay Thai, MMA and functional training. Book classes, track your streak, and connect with your gym." },
      { property: "og:title", content: "ATT Academy — Muay Thai & MMA" },
      { property: "og:description", content: "Book classes, track your streak, and train with the ATT team." },
