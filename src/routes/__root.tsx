...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ATT Academy - Muay Thai" },
      { name: "description", content: "- ATT Gym Hub is a web app for Muay Thai and MMA gyms, serving both members and staff." },
      { property: "og:title", content: "ATT Academy - Muay Thai" },
      { property: "og:description", content: "- ATT Gym Hub is a web app for Muay Thai and MMA gyms, serving both members and staff." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ATT Academy - Muay Thai" },
      { name: "twitter:description", content: "- ATT Gym Hub is a web app for Muay Thai and MMA gyms, serving both members and staff." },
